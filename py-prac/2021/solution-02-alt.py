...
def update_vert_pos_part_two(vert_pos, vert_change, value):
...
def runner(part):
	match part:
		case 'one':
			update_vert_pos_callback = update_vert_pos_part_one
		case 'two':
			update_vert_pos_callback = update_vert_pos_part_two
		case _:
